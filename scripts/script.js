...
const popupEditProfile = document.querySelector(".popup__type_edit-profile"); //окно профайла
const popupAddContentBtnOpen = document.querySelector(".profile__add-button"); //кнопка добавления контента
const popupAddContent = document.querySelector(".popup__type_add-place"); //окно добавления контента
...
const popupImage = document.querySelector(".popup__type_open-image"); //окно картинки
